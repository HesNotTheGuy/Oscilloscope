...
export const TOURS = {
  basics: [
    { sel: '#scope', title: 'This is the scope',
      body: 'Drop an audio file anywhere on it to see the waveform. Mic and system audio live in the Source tab on the right.',
      place: 'right' },
    { sel: '.tab-bar', title: 'Four rooms',
      body: 'Source is how sound gets in. Scope is the instrument — timebase, trigger, YT/XY. Beam is how the trace looks. Scene is shapes and images. Search jumps to any control by name.',
      place: 'left' },
    { sel: '.app:not(.tabbed-mode) #zone-right', title: 'Everything is a panel',
      body: 'Each panel collapses with a click on its title. Classic, Studio and Perform layouts spread them around the scope instead of stacking them in tabs.',
      place: 'left' },
    { sel: '#theme-select', title: 'Themes change the whole instrument',
      body: 'Tektronix blue, analog amber, synthwave. A theme sets the chrome and a default beam colour. Visual packs (in Source) change the look without changing the frame.',
      place: 'bottom' },
  ...
  patch: [
    ...
    { sel: '.pk-name', title: 'Rearrange your board',
      body: 'Drag a module by its name plate to move it. Double-click the plate to hide one you never use. BOARD in the header brings hidden modules back — Lights and the rest live there.',
      place: 'bottom' },
